...
> **For agentic workers:** This plan is part of a 8-phase mandatory development workflow. Use executing-plans skill to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
