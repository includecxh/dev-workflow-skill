...
5. Gate check
   ❌ Tests/review fail → back to Phase 5 to fix (≥2 no-progression round-trips trips the budget → stop and ask the user; see Phase 5 Core rules)
...
- Gate: fail → back to Phase 5 (≥2 no-progression round-trips trips the budget → stop and ask the user; see Phase 5 Core rules)
...
- If tests fail → back to Phase 5 (fix → re-verify through Phase 6 → re-enter Phase 7; ≥2 no-progression round-trips trips the budget → stop and ask the user; see Phase 5 Core rules)
